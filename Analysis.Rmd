...
### 6.2 Extreme Gradient Boosted Regression Trees
...
## subsample = 0.9 where XGBoost will collect randomly 90% of the training data to grow trees.
...
### Training.
## From the cross-validation, the optimal number of trees is 1569.
nrounds <- 1569
model = xgboost(param = param, train_matrix, nrounds = nrounds, verbose = 0)
