...
## Project Summary
This project has the purpose to predict how a supplier quotes a price on a given tube assembly. Knowing this information in advance we can determine the optimal quote which will maximize the profits of the company.
