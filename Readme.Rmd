...
4. We will then start the data analysis.
    ...
    e. Compare the accuracy obtained with the 95% needed
    f. If the accuracy obtained is worst than 95%, then we will identify why it's worst and start again at step 5.
    g. Even if the model failed, we will always keep trace of our research in a document.
5. When our method is proven better (accuracy obtained >= 95%), we will conclude by showing graphics and explain the advantage of using our method with business terms.
